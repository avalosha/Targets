...
final class EnrolledStudentTests: XCTestCase {
    ...
    func testGenerateInvoice_takingCourses_invoiceHasEnrollmentFeeAndCourseFees() {
        ...
        for testCourseCredits in testCourseCreditsArray {
            let expectedCourseFee = Fee(category: .course(TestConstants.someString), amount: testCourseCredits * Configuration.enrolledSudentCourseCreditFeeAmount)
