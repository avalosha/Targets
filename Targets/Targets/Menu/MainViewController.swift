...
class MainViewController: UIViewController {
    ...
    private func setupSideMenuShadow() {
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ option: MenuOptions) {
        showViewController(viewController: UINavigationController.self, storyboard: option.storyboard, storyboardId: option.storyId)
